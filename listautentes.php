...
if ($busca_total->rowcount(PDO::FETCH_ASSOC) > 0) {
	...
	if ($pag > 1) {
		$paginacao = '<a href="visualizarutentes.php?pag=' . $ant . '"><img src="dist/img/Back2.png" /></a>';
	}
...
if ($prox <= $ultima_pag && $ultima_pag >= 2) {
	$paginacao .= '<a href="visualizarutentes.php?pag=' . $prox . '"><img src="dist/img/Next.png" /></a>';
}

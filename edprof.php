...
$STH->execute();
	while ($row = $STH->fetch()) {
		echo '<form action="alterarprof.php" method="post" name="formtest"  enctype="multipart/form-data">
...
echo"<input type='button' onclick=location.href='verperfil.php?idut=".$id."' value='Cancelar'  class='btn btn-primary'>               
</div>";
?>

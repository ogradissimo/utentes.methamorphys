...
<div class='box box-default'>
	<div class='box-header with-border'>
		<h3 class='box-title'><a href='visualizarutentes.php'><i class='fa fa-fw fa-arrow-left'></a></i> Outras Observações:</h3>
		<div class='box-tools pull-right'>";
			...
			while ($row5 = $STH5 -> fetch()) {
				...
				{
				echo '<a href="outrosdocu.php?idut='.$id.'&op=2&voltar='.$ur=end(explode("/", $_SERVER['PHP_SELF'])).'"><img src="dist/img/edit.png" /></a>';

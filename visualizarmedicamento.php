...
Lista de Medicamentos
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Selecione um Medicamento</h3>
                  <div class="box-tools">
                    <div class="input-group">
                    	<a href="criarmedicamento.php"><img src="dist/img/add.png"></a> &nbsp;
            ...
            <?php include 'listamedicamentos.php';?>
             </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div>   

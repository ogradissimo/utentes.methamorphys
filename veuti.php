<div class='box box-default'>
	<div class='box-header with-border'>
		...
		<div class="box-tools pull-right">
											<?php
				$id2=$_GET['idut']; 
				echo '<a href="verutilizador.php?idut='.$id2.'&op=2"><img src="dist/img/edit.png" /></a>';
	?>
						</div>
...
$STH->execute();
	...
	echo '<br><a href="visualizarutilizadores.php"><img src="dist/img/back3.png" /> Voltar para a Tabela</a>';	
